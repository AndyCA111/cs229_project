...
from Sound2Scene.model import AVENet
import argparse
...
class AudioTokenWrapper(torch.nn.Module):
    ...
    def __init__(
        ...
        self.aud_encoder = AVENet(dp=18)
        ckpath = './Sound2Scene/checkpoints/sound2scene.pth'
        self.aud_encoder.load_state_dict(torch.load(ckpath))
